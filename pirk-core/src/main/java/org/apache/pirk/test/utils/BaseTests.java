...
public class BaseTests
{
  ...
  public static List<QueryResponseJSON> performQuery(String queryType, List<String> selectors, FileSystem fs, String platformName, int numThreads)
      throws Exception
  {
    ...
    return responder.runDistributedTest(args, fs, querier, numThreads);
  }
