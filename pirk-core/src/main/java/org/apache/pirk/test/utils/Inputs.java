...
public class Inputs
{
  ...
  {
    String nodesProperty =SystemConfiguration.getProperty(DistributedTestDriver.ES_INPUT_NODES_PROPERTY);
    if(nodesProperty == null || nodesProperty.equals("none")) {
      logger.info("{} no set skipping Elastic Search index deletion",DistributedTestDriver.ES_INPUT_NODES_PROPERTY);
      return;
    }
